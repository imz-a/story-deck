...
const GENRES = {
    ...
    stages: [
      ...
      },
      {
        ...
        caps: [
          ...
          "我躲进楼梯间的储物柜，心跳快得像在敲鼓——柜门内侧，刻满了抓痕。",
        ],
        prompts: [
          "黑暗走廊，无数扇老木门同时震颤，门牌晃动，强压迫感构图",
          "完全黑暗中一束手电光扫过门牌，尘埃浮动，惊悚氛围",
          "狭窄储物柜内部向外窥视的第一人称视角，柜门缝隙微光，刻痕细节，惊悚氛围",
        ],
      },
      {
        weight: 2, key: "反转",
  ...
  minguo: {
    label: "民国奇幻",
    slots: {
      place: "拾遗当铺", role: "当铺朝奉", item: "铜皮灯",
      npc: "戴瓜皮帽的老掌柜", weird: "提白纸灯笼的姑娘",
    },
    stages: [
      {
        weight: 1, key: "入场",
        caps: [
          "熄灯巷子时才开门。{place}的柜台比街面高出三级，规矩只有一条：当东西的人，不许看朝奉的脸。",
          "我接过今晚第一件当物时，柜台上那盏{item}，忽然自己亮了。",
        ],
        prompts: [
          "民国深夜当铺，高柜台后一盏铜灯昏黄，门外雨巷石板路反光，冷暖对比，电影感",
          "穿灰布长衫的年轻朝奉在柜台后清点当物，铜灯特写，浅景深，暖金色调",
        ],
      },
      {
        weight: 2, key: "典当",
        caps: [
          "{npc}把一块停摆的怀表推过柜台：今晚这单，当的是他后半辈子的时辰。",
          "当票落笔，墨迹未干，票面上赫然写着两个字：死当。",
        ],
        prompts: [
          "当铺柜台特写，泛黄当票与停摆怀表，毛笔字迹未干，烛光暖调",
          "老掌柜压低帽檐隔着高柜台低语，光影将画面一分为二，悬疑构图",
        ],
      },
      {
        weight: 2, key: "异象",
        caps: [
          "我数了数柜里的{item}——灯芯的火苗，比昨天矮了一截。",
          "巷子里今天又多了一个人。他站在原地想了很久，想不起来自己要当什么。",
        ],
        prompts: [
          "柜中一排铜灯，其中一盏火苗明显矮小，昏暗仓库纵深构图，诡异静谧",
          "雨巷尽头呆立的路人背影，灯笼微光，空旷压抑，冷调",
        ],
      },
      {
        weight: 2, key: "危机",
        caps: [
          "{weird}把白纸灯笼搁上柜台。灯影晃了三晃——地上，她没有影子。",
          "打烊的梆子响了三声。可熄灯巷的规矩，是从来不打烊的。",
        ],
        prompts: [
          "白纸灯笼照亮柜台，提灯姑娘衣袂素白，脚下地面空无一影，高对比惊悚",
          "深夜当铺门板缝隙中透出微光，第一人称窥视视角，悬念氛围",
        ],
      },
      {
        weight: 2, key: "反转",
        caps: [
          "当铺收的从来不是物件——是当东西的人，这辈子再也想不起来的那一部分。",
          "灯罩的铜皮上映出一张脸。原来三十年前，把名字押在这柜台上的，是我。",
        ],
        prompts: [
          "铜皮灯罩特写映出年轻女子的脸，火苗倒影摇曳，戏剧性顶光",
          "昏暗账房，摊开的旧账本上一行名字被朱笔划去，烛光斜照，特写",
        ],
      },
      {
        weight: 1, key: "钩子",
        caps: [
          "天亮前，我把自己的名字重新写上了当票。下一集，讲讲我赎不回来的东西。",
          "门板被叩了三下。今晚的客人，当来的是一张遗像。",
        ],
        prompts: [
          "主角背影立于高柜台之后，铜灯独亮，钩子式留白构图",
          "当铺木门特写，门环轻叩微动，门缝透出一线昏光，悬念收尾",
        ],
      },
    ],
  },
